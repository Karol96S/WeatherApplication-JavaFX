...
//        String uri = Connector.buildApiRequest(city);
//        String rawData = Connector.sendRequest(uri);
////        String weatherData = prepareApiData(rawData);
////        return weatherData;
//    }

//    public void prepareApiData(String rawData) throws IOException, InterruptedException {
//        //String rawData = sendRequest();
//        JSONObject timelineResponse = new JSONObject(rawData);
//        ZoneId zoneId = ZoneId.of(timelineResponse.getString("timezone"));
//        System.out.printf("Weather data for: %s%n", timelineResponse.getString("resolvedAddress"));
